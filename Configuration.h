...
// motherboard 33 is the reprap one, which harry used and i can use, just trying out using the board i actually have!
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 89 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 5, 15 }
...
//#define REPRAP_GRAPHIC_SMART_CONTROLLER
//#define REPRAP_SMART_DISPLAY_CONTROLLER
